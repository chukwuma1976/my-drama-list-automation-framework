...
test.describe("Get drama details", () => {
    ...
    test("get drama details for a drama", { tag: ['@smoke', '@regression'] }, async ({ request }) => {
    ...
    test("get drama details with missing parameter", { tag: ['@regression'] }, async ({ request }) => {
    ...
    test("get drama details with invalid parameter", { tag: ['@regression'] }, async ({ request }) => {
