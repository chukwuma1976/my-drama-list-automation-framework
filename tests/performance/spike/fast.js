...
import { spikeOptions } from "../utils/options.js";
...
export default function () {
    ...
    performanceTestingEndpoints
        .filter(el => el.tier === "fast")
        .forEach(endpoint => {
            const options = spikeOptions(endpoint.threshold);
...
export function handleSummary(data) {
    return {
        "reports/performance/spike-report-fast.html": htmlReport(data),
    };
}